...
class Attendace:
    def __init__(self,root):
        ...
        self.root.title("Smart Attendace System")
        ...
        title=Label(self.root,text="Smart Attendace System",font=("Magneto",35,"bold"),bg="skyblue",fg="crimson")
        title.place(x=0,y=150,width=1550,height=45)

        Manage_std_frame=Frame(bg_lbl,bd=2,relief=RIDGE,bg="skyblue")
        Manage_std_frame.place(x=15,y=10,width=1500,height=515)

        # myname=Label(self.root,text="Developed ",fg="skyblue",bg="black",font=("Magneto",18,"bold"))
        # myname.place(x=0,y=0)
        

        #  ================Left labelframe=================
        DataFrameLeft=LabelFrame(Manage_std_frame,bd=4,padx=2,relief=RIDGE,fg="crimson",bg="skyblue",
                                                font=("Magneto",12,"bold"),text="Student Information ")
        DataFrameLeft.place(x=10,y=5,width=660,height=480)

        updateframe=Frame(DataFrameLeft,bd=2,relief=RIDGE,bg="skyblue")
        ...
        empLabel=Label(updateframe,text="Student ID:",bg="skyblue",font="comicsansns 11 bold")
        empLabel.grid(row=0,column=0,padx=4,pady=8)

        nameLabel=Label(updateframe,text="Roll:",bg="skyblue",font="comicsansns 11 bold")
        nameLabel.grid(row=0,column=2,padx=4,pady=8)

        dateLabel=Label(updateframe,text="Name:",bg="skyblue",font="comicsansns 11 bold")
        dateLabel.grid(row=1,column=0)

        dateLabel=Label(updateframe,text="Department:",bg="skyblue",font="comicsansns 11 bold")
        dateLabel.grid(row=1,column=2)

        dateLabel=Label(updateframe,text="Time:",bg="skyblue",font="comicsansns 11 bold")
        dateLabel.grid(row=2,column=0)

        dateLabel=Label(updateframe,text="Date:",bg="skyblue",font="comicsansns 11 bold")
        dateLabel.grid(row=2,column=2)

        attendanceLabel=Label(updateframe,text="Attendance Status",bg="skyblue",font="comicsansns 11 bold")
        ...
        btnAddData=Button(ButtonFrame1,text="Import csv",command=self.importData,font=("Magneto",11,"bold"),width=16,bg="lime",fg="skyblue")
        btnAddData.grid(row=0,column=0,padx=1)

        btnUpdate=Button(ButtonFrame1,text="Export csv",command=self.export_data,font=("Magneto",11,"bold"),width=16,bg="lime",fg="skyblue")
        btnUpdate.grid(row=0,column=1,padx=1)

        btnDelete=Button(ButtonFrame1,text="Update",command=self.action,font=("Magneto",11,"bold"),width=16,bg="lime",fg="skyblue")
        btnDelete.grid(row=0,column=2,padx=1)

        btnReset=Button(ButtonFrame1,text="Reset",command=self.clear,font=("Magneto",11,"bold"),width=16,bg="lime",fg="skyblue")
        btnReset.grid(row=0,column=3,padx=1)

        #  ================Right labelframe=================
        DataFrameRight=LabelFrame(Manage_std_frame,bd=4,padx=2,relief=RIDGE,bg="skyblue",fg="crimson",
                                                font=("Magneto",12,"bold"),text="Student Details")
        DataFrameRight.place(x=670,y=5,width=600,height=480)

        AttendanceFrame=Frame(DataFrameRight,bd=2,relief=RIDGE,bg="skyblue")
    ...
    # ======back=========
        btnback=Button(title,text="Back",command=self.go_back,font=("Magneto",11,"bold"),width=17,bg="skyblue",fg="red")
