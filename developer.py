...
class Developer:
    def __init__(self,root):
        ...
        # img1 = Image.open(r"college_images\Raj.jpg")
        ...
        img111 = img111.resize((250,250), Image.ANTIALIAS)
        self.photoImg111 = ImageTk.PhotoImage(img111)
        bg_lbl=Label(Manage_std_frame1,image=self.photoImg111,bg="white")
        bg_lbl.place(x=0,y=200,width=250,height=250)

        support=Label(Manage_std_frame1,bg="black",fg="white",text="Hello,my Team is",font=("times new roman",17,"bold"))
        support.place(x=10,y=10)

        support=Label(Manage_std_frame1,bg="black",fg="blue",text="GROUP-31",font=("times new roman",22,"bold"))
        support.place(x=10,y=45)

        # support=Label(Manage_std_frame1,bg="black",fg="blue",text="Shashank Smeer",font=("times new roman",22,"bold"))
        # support.place(x=10,y=80)

        # support=Label(Manage_std_frame1,bg="black",fg="blue",text="Siddhartha Khare",font=("times new roman",22,"bold"))
        # support.place(x=20,y=55)

        # support=Label(Manage_std_frame1,bg="black",fg="blue",text="Kishan Raj",font=("times new roman",22,"bold"))
        # support.place(x=25,y=60)

        support=Label(Manage_std_frame1,bg="black",fg="white",text="Students of Greater Noida Institute of Technology",font=("arial",12,"bold"))
        support.place(x=30,y=110)
        ...
        support=Label(Manage_std_frame1,bg="black",fg="white",text="programming langueges python,javascript,c",font=("arial",12,"bold"))
